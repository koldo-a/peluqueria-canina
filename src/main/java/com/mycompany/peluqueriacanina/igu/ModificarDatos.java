...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificarMascota(masco, nombreMasco, raza, color, observaciones, alergico, atenEsp, nombreDuenio, celular);
    ...
    private void CargarDatos(int num_cliente) {
        ...
        txtDuenyo.setText(masco.getUnDuenio().getNombre());
        txtObservaciones.setText(masco.getObservaciones());
        txtCelDuenyo.setText(masco.getUnDuenio().getCelular());
        
        if(masco.getAlergico().equals("SI")){
                cmbAlergico.setSelectedIndex(1);
        } else {
            if(masco.getAlergico().equals("NO")){
                cmbAlergico.setSelectedIndex(2);} else {
        cmbAtEsp.setSelectedIndex(0);}
        }
        ...
        if(masco.getAtencion_especial().equals("SI")){
            ...
            if(masco.getAtencion_especial().equals("NO")){
                cmbAtEsp.setSelectedIndex(2);} else {
        cmbAtEsp.setSelectedIndex(0);}
        }
    }
